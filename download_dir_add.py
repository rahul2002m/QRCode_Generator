...
class QGen:
    def __init__(self, root):
        ...
        entryFrame = Frame(self.root, bd=2, relief=RIDGE, bg='orange')
        ...
        lbl_code = Label(entryFrame, text="Name :", font=("times new roman", 15, 'bold'), bg='orange').place(x=20,
                                                                                                                 y=60)
        lbl_name = Label(entryFrame, text="Company :", font=("times new roman", 15, 'bold'), bg='orange').place(x=20, y=100)

        lbl_dept = Label(entryFrame, text="E-mail :", font=("times new roman", 15, 'bold'), bg='orange').place(x=20,
                                                                                                                y=140)
        lbl_phno = Label(entryFrame, text="Tel. Number :", font=("times new roman", 15, 'bold'), bg='orange').place(x=20,
                                                                                                                  y=180)
        lbl_folder = Label(entryFrame, text="Pick Location : ", font=("times new roman", 15, 'bold'), bg='orange').place(x=20,y=220)
